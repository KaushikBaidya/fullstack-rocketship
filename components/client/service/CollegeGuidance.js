    ...
    <main>
      <section className="py-4 sm:py-8 lg:py-10">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <ul className="max-w-7xl mx-auto mt-16 space-y-12">
            ...
            <li className="relative flex items-start">
              ...
              <div className="ml-6">
                ...
                <p className="mt-4 text-[.9rem] font-medium ">
                  ...
                  before attending a undergraduate college in United States. We
                  recommend you apply one year before you pass your HSC /
            ...
            <li className="relative flex items-start">
              ...
              <div className="ml-6">
                ...
                <p className="mt-4 text-[.9rem] font-medium">
                  ...
                  among others. Our team offers strategic college guidance with
                  a professional and individualized touch. You can trust our
                  coaches because they care for you, are approachable, and are
                  relatable.
                </p>
              </div>
            </li>
            ...
            <li className="relative flex items-start">
              ...
              <div className="ml-6">
                ...
                <p className="mt-4 text-[.9rem] font-medium">
                  Universities have testing requirements such as IELTS, TOFL or
                  the SAT. We will guide on most suitable test needed and help
                  you succeed on these exams
                </p>
              </div>
            </li>
